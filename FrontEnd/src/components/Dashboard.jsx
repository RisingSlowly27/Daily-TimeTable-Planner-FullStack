    ...
    return (
        <>
            ...
            <div className='min-w-90 p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 justify-items-center'>
                ...
                <div className='h-fit w-full lg:max-h-[736px] md:max-h-[571px] max-h-[400px] overflow-auto col-span-1 md:col-span-2 lg:col-span-7 m-3 p-3 bg-yellow-200 justify-items-center border'>
